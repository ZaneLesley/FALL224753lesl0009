...
inputPanel(
  ...
  selectInput("plotg", "Choose plot type",
      list(`points` = c("g", "gpoints", "gratio"),
...
renderPlot({
 ...
 gsh =  g + geom_point(aes(col = Height))
 
 gsr = g + geom_point(aes(size = BHDiameter, col = BHDiameter))
 
  ggr = ggplot(spruce.df, aes(x = BHDiameter, y = Height, color=BHDiameter))
  ggr = ggr + geom_point() + geom_line() + geom_smooth(method = "lm")
  ggr = ggr + ggtitle("Tree Height vs Breast Height Diameter - Plot by Zane L")
 ...
 if(input$plotg == "gsheat")   print(ggr)
