...
![Reconstruction of meat roasting on campfire at the Lazaret Cave, France. Credit: De Lumley, M. A. . néandertalisation (pp. 664-p). CNRS éditions.](Roasting-on-Campfire.jpg "Reconstruction of meat roasting on campfire at the Lazaret Cave, France. Credit: De Lumley, M. A. . néandertalisation (pp. 664-p). CNRS éditions."){ width=100% }
...
![Main fire-history phases driven by anthropogenic (socioeconomic) changes in the last two centuries.](fire_over_time.png "Main fire-history phases driven by anthropogenic (socioeconomic) changes in the last two centuries."){ width=100% }
